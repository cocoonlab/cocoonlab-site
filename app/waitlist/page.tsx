      ...
      <section className="section-pad">
        <div className="container-x grid gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] md:items-start">
          <div className="space-y-5">
            ...
            <div className="grid gap-4 rounded-2xl border border-border-subtle bg-surface-raised/70 p-4 text-sm text-text-muted md:grid-cols-2">
              <div>
            ...
            <div className="card-surface flex items-center gap-4 p-4 text-sm text-text-muted">
              <div className="h-14 w-14 rounded-2xl border border-border-subtle bg-surface-sunken" />
              <div>
