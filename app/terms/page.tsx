        ...
        <div className="container-x space-y-8">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="space-y-4 rounded-2xl border border-divider bg-surface-sunken p-6">
              <h2 className="text-lg font-semibold tracking-tight text-ink">Use of Cocoon</h2>
            ...
            <div className="space-y-4 rounded-2xl border border-divider bg-surface-sunken p-6">
              <h2 className="text-lg font-semibold tracking-tight text-ink">Accounts & billing</h2>
              <ul className="space-y-3 text-sm leading-relaxed text-text-muted">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="space-y-4 rounded-2xl border border-divider bg-surface-sunken p-6">
              <h2 className="text-lg font-semibold tracking-tight text-ink">Intellectual property</h2>
