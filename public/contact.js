...
const contactText = {
  en: {
    ...
    demoNote: "You’re booking a Cocoon demo. Share the project, team, and timing.",
  ...
  fr: {
    ...
    demoNote: "Vous réservez une démo Cocoon. Partagez le projet, l’équipe et le calendrier.",
